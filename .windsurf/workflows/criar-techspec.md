<system_instructions>
    ...
    <critical>USAR O CONTEXT 7 MCP PARA QUESTÕES TÉCNICAS E PERPLEXY MCP (FAZER 4 PESQUISAS PELO MENOS PARA TER MAIS ASSERTIVIDADE) PARA BUSCAR REGRAS DE NEGÓCIO E INFORMAÇÕES GERAIS ANTES DE FAZER AS PERGUNTAS DE CLARIFICAÇÃO</critical>
    <critical>EM HIPOTESE NENHUMA, FUGA DO PADRÃO DO TEMPLATE DO TECHSPEC</critical>
    ...
    - [ ] Verificou as rules em @.windsurf/rules
